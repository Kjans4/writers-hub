...
// Collects: title, hook (120 chars), description (800 chars),
// content rating, story status.
    ...
    <div className="space-y-7">
      ...
      <div>
        ...
        <p className="text-xs text-stone-300 font-['Inter'] mt-1">
          Pre-filled from your project title — edit freely.
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          value={data.hook}
          onChange={(e) => {
            if (e.target.value.length <= 120) onChange({ hook: e.target.value })
          }}
        ...
        <div className="flex justify-between mt-1">
          <p className="text-xs text-stone-300 font-['Inter']">
            Shown on story cards in the feed. Make it irresistible.
          </p>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) => {
            if (e.target.value.length <= 800) onChange({ description: e.target.value })
          }}
          rows={4}
        ...
        <div className="flex gap-2">
          {STATUSES.map(({ value, label }) => (
            <button
              ...
              className={`
                px-4 py-2 rounded-lg text-sm font-['Inter'] border transition-colors
                ${data.status === value
