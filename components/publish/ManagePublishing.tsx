...
// Phase E update: tabbed refactor.
// Adds a "Chapters | Earnings" tab bar at the top.
// Existing chapter management moves to the "Chapters" tab.
// EarningsDashboard mounts in the "Earnings" tab.
// Both live at the same route /publish/[projectId] — no new route needed.
...
import {
  Globe, Copy, Check, Loader2, AlertTriangle, ExternalLink,
  ChevronDown, BookOpen, TrendingUp,
} from 'lucide-react'
...
type ActiveTab = 'chapters' | 'earnings'
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-2xl mx-auto px-6">
          <div className="flex items-center gap-0">
            <button
              ...
              className={`
                flex items-center gap-1.5 px-4 py-3 text-sm font-medium font-['Inter']
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-10">
        ...
        {/* ── Earnings tab ──────────────────────────────────── */}
        {activeTab === 'earnings' && (
          <EarningsDashboard projectId={project.id} />
        )}
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs text-stone-500 font-['Inter'] mb-1.5">
                    Genre
                  </label>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 flex-shrink-0">
                        <span className={`text-xs font-['Inter'] ${
                          chapter.is_published ? 'text-emerald-600' : 'text-stone-400'
                        }`}>
