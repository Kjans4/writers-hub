// app/(editor)/project/[projectId]/chapter/[chapterId]/page.tsx
// Chapter editor route.
...
export default function ChapterPage() {
  ...
  const { setActiveDocument, setActiveDocumentOrderIndex, activeBranchId } = useEditorStore()
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      setActiveDocumentOrderIndex(null)
    }
  }, [chapterId])
  ...
  if (!document || !activeBranchId) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <p className="text-stone-400 font-['Inter'] text-sm">Chapter not found.</p>
      </div>
    )
  }
